...
public final class Config {
	...
	//region Enemy
	public static final double NORMAL_ENEMY_SIZE = 0.6 * TILE_SIZE;
	...
	public static final double TANKER_ENEMY_SIZE = 0.8 * TILE_SIZE;
	...
	public static final double BOSS_ENEMY_SIZE = 2.0 * TILE_SIZE;
